...
?>
    ...
    <div class="col-md-4">
        <div class="card card-profile">
            ...
            <div class="content">
                <h6 class="category text-gray">Systems Secretary</h6>
                <h4 class="card-title">Sir/Madam <?php echo $username?> </h4>
                <p class="card-content">
                    I am the secretary of this system,working for tarclink and tevinson company.
